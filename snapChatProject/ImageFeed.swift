...
var seen: [String: [Bool]] = ["Memes": [], "Dog Spots": [], "Random": []]
var timeSent: [String: [Date]] = ["Memes": [], "Dog Spots": [], "Random": []]
//
...
func getTimeDiff(sentDate: Date) -> String {
    let timeIntervalPassed = sentDate.timeIntervalSinceNow
    return String(Int(-timeIntervalPassed)) + "s ago"
}
